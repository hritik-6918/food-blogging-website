      ...
      >
        <Box>
          ...
          <Flex mt={{ lg: '.8em' }} color={'#0E2368'} gap={{ lg: '2em',base:'1em' }}>
           <a class="w3-btn w3-margin-bottom" href="https://instagram.com/curious_hrithik6918?igshid=MzNlNGNkZWQ4Mg==" target="_blank"><Icon w={{lg:'30px' , base:'16px'}} h={{lg:'30px' ,base:'16px'}} as={AiOutlineInstagram} /></a>
           <a href="https://twitter.com/hritik/" target="_blank"><Icon w={{lg:'30px' , base:'16px'}} h={{lg:'30px' ,base:'16px'}} as={AiOutlineTwitter} /></a>
           <a href="https://www.facebook.com/hritik/" target="_blank"><Icon w={{lg:'30px' , base:'16px'}} h={{lg:'25px' ,base:'16px'}} as={ImFacebook} /></a>
          </Flex>
        </Box>
